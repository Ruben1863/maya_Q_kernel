...
#define CUST_EINT_ALSPS_MTK_NUM              6
#define CUST_EINT_ALSPS_MTK_DEBOUNCE_CN      0
#define CUST_EINT_ALSPS_MTK_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_ALSPS_MTK_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
